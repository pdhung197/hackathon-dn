...
class Map extends Component {
    constructor(props) {
        ...
        console.log('aaaaaaaaaaaaa', this.props.center)
        console.log('bbbbbbbbbbbbb', this.props.center)
        console.log('ccccccccccccc', this.props.center)
    }
    /**
    ...
    onMarkerDragEnd = event => {
        ...
        Geocode.fromLatLng(newLat, newLng).then(
            response => {
                ...
                if (this.props.proc) this.props.proc(address, newLat, newLng)
            },
            error => {
                console.error(error)
            },
